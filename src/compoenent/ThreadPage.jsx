...
const ThreadPage = ({ selectedThread }) => {
  ...
  return (
    <div className="overflow-y-scroll no-scrollbar  h-full">
      ...
      <div
        className="cursor-pointer flex items-center w-[150px] text-white bottom-0 ml-10 mb-10 bg-gradient-to-r from-[#4B63DD] to-[#0524BFFC] rounded-md px-10 py-2"
        onClick={togglePopUp}
      >
        <FaReply className="mr-2 text-xl text-white" /> Reply
      </div>
      {showDelete && (
        <DeleteBox
